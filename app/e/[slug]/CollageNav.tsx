...
export default function CollageNav({
  ...
  const CARD_W = 560;
  const CARD_H = 560; // πιο κοντά σε τετράγωνο (αν το θες πιο square κάνε 520/520)

  // Τώρα θέλουμε ΣΤΟΙΒΑ: μικρό overlap και να "πατάει" η κάθε επόμενη ΠΑΝΩ στην προηγούμενη
  // Άρα STEP_Y μικρό, όχι κοντά στο ύψος.
  const STEP_Y = 70;  // όσο πιο μικρό, τόσο περισσότερο overlap
  const STEP_X = 120;  // δεξιά/αριστερά εναλλάξ
